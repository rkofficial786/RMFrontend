  ...
  return (
    <View style={{ flex: 1, backgroundColor: darkMode ? COLORS.blackyish : LightCOLORS.white }}>
      ...
      <View style={[styles.container, {}]}>
        ...
        <TextCustom customStyle={textStyle.fs_600_24} color={darkMode ? COLORS.white : LightCOLORS.blackyish}>Signup </TextCustom>
        <View style={styles.main_container}>
          <Input
            leftIcon={<Icon name="user" size={28} color={darkMode ? COLORS.white : LightCOLORS.primary} />}
            label="First Name"
          ...
          <View style={{ marginTop: sizer.horizontalScale(10) }}>
            <Button onPress={handleSignup} loading={loading}>Signup</Button>
          </View>
          ...
          <View style={{ flexDirection: "row", alignSelf: "center" }}>
            ...
            <Pressable onPress={() => navigation.navigate("Login")}><TextCustom customStyle={[styles.login_text, { borderBottomColor: darkMode ? COLORS.ButtonSecondarylight : LightCOLORS.primary, color: darkMode ? COLORS.ButtonSecondarylight : LightCOLORS.primary }]}>Login</TextCustom></Pressable>
